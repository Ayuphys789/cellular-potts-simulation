...
$$
H = \sum_{\langle i,j \rangle} J(\tau_i, \tau_j)\,(1 - \delta_{\sigma_i,\sigma_j}) +\sum_\sigma \lambda_V (V(\sigma) - V_\text{target})^2  + \sum_\sigma \lambda_P (P(\sigma) - P_\text{target})^2
$$
...
- **Jagged ($T=28, \lambda_P=0.0$):** 膜制約がなく、熱ゆらぎが大きい → 悪性腫瘍のように周囲へ浸潤する樹状構造。
